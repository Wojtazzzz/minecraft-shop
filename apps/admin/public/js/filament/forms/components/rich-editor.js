var Mi = "2.1.4",
    ...
    ji = [h.bytes, h.KB, h.MB, h.GB, h.TB, h.PB],
    vi = {
        prefix: "IEC",
        precision: 2,
        formatter(n) {
    ...
    p = function (n) {
        let {
            ...
            u = function (b) {
                ...
                let A = q(b.target, { matchingSelector: l });
            ...
            : ot(n) ||
                  (!ot(n.firstChild) &&
                      (function (e) {
                          return (
                              At().includes(x(e)) &&
                              !At().includes(x(e.firstChild))
                          );
                      })(n));
    },
    ot = (n) => Ui(n) && n?.data === "block",
    Ui = (n) => n?.nodeType === Node.COMMENT_NODE,
    st = function (n) {
        let { name: t } =
            arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        if (n)
    ...
    $ = (n) => xi(n, K),
    yi = (n) => xt(n) && n?.data === "",
    xt = (n) => n?.nodeType === Node.TEXT_NODE,
    qe = {
        level2Enabled: !0,
        getLevel() {
...
`,
    ...
    f = class {
        static proxyMethod(t) {
            let { name: e, toMethod: i, toProperty: r, optional: o } = qi(t);
...
var Ji = 0,
    ...
    me = null,
    Dt = null,
    Le = () => (de || (de = Xi().concat(Gi())), de),
    v = (n) => y[n],
    Gi = () => (ge || (ge = Object.keys(y)), ge),
    De = (n) => Y[n],
    Xi = () => (me || (me = Object.keys(Y)), me),
    ki = function (n, t) {
    ...
    Qi = (n) => Qe(n.startContainer) || Qe(n.endContainer),
                ...
                Array.from(e).forEach((s) => {
                    ...
                    if (t) {
                        ...
                        if (
                            ...
                            l !== void 0 &&
                            l.call(s, i) &&
                            (c = (u = t[t.length - 1]).canBeGroupedWith) !==
                                null &&
                            c !== void 0 &&
                            c.call(u, s, i)
                        )
...
var M = class extends f {
    ...
    rn = "style href src width height language class".split(" "),
    on = "javascript:".split(" "),
    sn = "script iframe form noscript".split(" "),
    lt = class extends f {
        static setHTML(t, e) {
            let i = new this(e).sanitize(),
    ...
    Ot = class extends M {
        ...
        createAttachmentNodes() {
            let t = this.attachment.isPreviewable() ? Nt : kt;
...
`);
    ...
    Mt = class extends M {
        ...
        createNodes() {
            let t = [],
                e = Ct.groupObjects(this.getPieces()),
                i = e.length - 1;
            for (let o = 0; o < e.length; o++) {
                ...
                let l = this.findOrCreateCachedChildView(Ot, s, {
    ...
    ct = class extends M {
        ...
        render() {
            if (
                ...
                let t = Ct.groupObjects(this.document.getBlocks(), {
                    asTree: !0,
                });
                Array.from(t).forEach((e) => {
    ...
    un = (n, t) => oi(n.innerHTML) === oi(t.innerHTML),
    oi = (n) => n.replace(/&nbsp;/g, " ");
function wt(n) {
    var t, e;
    function i(o, s) {
    ...
    (this._invoke = function (o, s) {
        return new Promise(function (a, l) {
            var c = { key: o, arg: s, resolve: a, reject: l, next: null };
...
var ut = class extends O {
        ...
        transformObjectsInRange(t, e) {
            let [i, r, o] = this.splitObjectsAtRange(t),
                s = i.map((a, l) => (r <= l && l <= o ? e(a) : a));
            return new this.constructor(s);
        }
        splitObjectsAtRange(t) {
            let e,
                [i, r, o] = this.splitObjectAtPosition(mn(t));
            return (
        ...
        isEqualTo(t) {
            return (
                super.isEqualTo(...arguments) || gn(this.objects, t?.objects)
            );
        }
        contentsForInspection() {
            return {
        ...
        increaseNestingLevel() {
            ...
            if (t) {
                let e = this.attributes.lastIndexOf(t),
                    i = Ve(this.attributes, e + 1, 0, ...si(t));
                return this.copyWithAttributes(i);
            }
            return this;
        }
...
`),
    ...
    vn = R.textForStringWithAttributes(
        `
`,
        { blockBreak: !0 },
    ),
    ...
    xn = (n) => n.copyWithoutAttribute("blockBreak"),
    si = function (n) {
    ...
    k = class extends O {
        ...
        mergeDocumentAtRange(t, e) {
            ...
            let [o] = e,
                ...
                l = t.getBaseBlockAttributes(),
                c = a.slice(-l.length);
            if (Q(l, c)) {
                let A = a.slice(0, -l.length);
            ...
            let u = i.getBlockCount(),
                b = i.getBlockAtIndex(0);
            if (Q(a, b.getAttributes())) {
                let A = b.getTextWithoutBlockBreak();
...
`
                ...
                let L,
                    gt = c.text.getTextAtRange([0, l]),
                    P = A.text.getTextAtRange([b, A.getLength()]),
                    it = gt.appendText(P);
                L =
                    a !== u &&
                    l === 0 &&
        ...
        expandRangeToLineBreaksAndSplitBlocks(t) {
            ...
            if (
                ...
                let c = a.getBlockAtIndex(s.index);
...
`
        ...
        getCommonAttributesAtPosition(t) {
            ...
            if (!s) return {};
            let a = ci(s),
                l = s.text.getAttributesAtPosition(o),
                c = s.text.getAttributesAtPosition(o - 1),
                u = Object.keys(Y).filter((b) => Y[b].inheritable);
            for (e in c)
        ...
        getRangeOfCommonAttributeAtPosition(t, e) {
            let { index: i, offset: r } = this.locationFromPosition(e),
                ...
                c = this.positionFromLocation({ index: i, offset: a });
            return g([l, c]);
        }
    ...
    et = class extends f {
        ...
        parse() {
            try {
                ...
                let t = Ft(this.containerElement, { usingFilter: Cn });
...
`,
    ...
    kn = (n) => n.replace(new RegExp("^".concat(ze.source, "+")), ""),
    Rn = (n) => new RegExp("^".concat(ze.source, "*$")).test(n),
    Ti = (n) => /\s$/.test(n),
    En = [
        "contenteditable",
        "data-trix-id",
    ...
    wn = Object.freeze({ __proto__: null }),
    m = class extends f {
        constructor(t, e) {
            super(...arguments),
        ...
        insertAttachments(t) {
            ...
            return (
                Array.from(t).forEach((i) => {
                    ...
                    s && (a.presentation = s);
                    let l = R.textForAttachmentWithAttributes(i, a);
                    e = e.appendText(l);
                }),
                this.insertText(e)
            );
...
` &&
    ...
    zt = class {
        ...
        findLocationFromContainerAndOffset(t, e) {
            ...
            let l = Ft(this.element, { usingFilter: Fi });
            for (; l.nextNode(); ) {
                let c = l.currentNode;
                if (c === t && xt(t)) {
                    st(c) || (s.offset += e);
        ...
        getSignificantNodesForIndex(t) {
            let e = [],
                i = Ft(this.element, { usingFilter: Fn }),
                r = !1;
            for (; i.nextNode(); ) {
                let s = i.currentNode;
                var o;
    ...
    I = class extends f {
        ...
        selectionIsCollapsed() {
            var t;
            return (
                ((t = yt()) === null || t === void 0 ? void 0 : t.collapsed) ===
                !0
            );
        }
        selectionIsExpanded() {
            ...
            super(...arguments),
                ...
                E(
                    ...
                    xe(() => {
                        ...
                        let l = this.element.querySelector("figcaption"),
                            c = l.cloneNode();
                        return {
                            do: () => {
                                if (
    ...
    Kt = class extends f {
        ...
        didClickAttachment(t, e) {
            ...
            let o = this.findAttachmentForElement(e),
                s = !!q(t.target, { matchingSelector: "figcaption" });
    ...
    E(G, "inputTypes", {
        ...
        insertFromPaste() {
            ...
            if (e) {
                ...
                let c = n.getData("public.url-name");
                (l = c ? _e(c).trim() : e),
...
var Jn = function (n) {
    ...
    Kn = (n) => {
        var t;
        return (
            ((t = n.dataTransfer.files) === null || t === void 0
                ? void 0
                : t[0]) &&
            !Oi(n) &&
            !((e) => {
    ...
    Me = "[data-trix-action]",
    Xn = "".concat(Oe, ", ").concat(Me),
    ee = "[data-trix-dialog]",
    Yn = "".concat(ee, "[data-trix-active]"),
    Zn = "".concat(ee, " [data-trix-method]"),
    ...
    Yt = class extends f {
        ...
        hideDialog() {
            let t = this.element.querySelector(Yn);
            var e;
            if (t)
                return (
                    t.removeAttribute("data-trix-active"),
...
var Qt = class extends HTMLElement {
        ...
        get labels() {
            ...
            let e = q(this, { matchingSelector: "label" });
        ...
        clickBubbled(t) {
            ...
            let e = q(t.target, { matchingSelector: "label" });
