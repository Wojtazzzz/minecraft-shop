  ...
  <UiContainer>
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-6 lg:max-w-sm">
          <p class="text-sm text-gray-800">
            ...
            accusantium doloremque laud antium, totam rem aperiam.
          </p>
        </div>
      </div>
    ...
    >
      <p class="text-sm text-gray-600">
        © Copyright {{ new Date().getFullYear() }} Minecraft Shop. All rights
        reserved.
      </p>
      <ul
      ...
      >
        <li>
          <UiInternalLink to="/">
            <span class="text-sm text-gray-600"> F.A.Q </span>
          </UiInternalLink>
        </li>
        <li>
          <UiInternalLink to="/">
            <span class="text-sm text-gray-600"> Privacy Policy </span>
          </UiInternalLink>
          <a
            href="/"
